...
class BalanceServiceTest {
    ...
    void successfulAccountCreationDeletionTest() {
        ...
        Assertions.assertEquals("Ding",balanceService.accountRepository().getAccount(accountId1).getName());
    ...
    void debitWithInsufficientBalance() {
        ...
        // Also adding here the test for the setBalance() method in Account
